...
tf.flags.DEFINE_string("x_train_filepath", "../data/dataset/sample_seq2seq/train/train.article.txt", "Path to a file containing X training sentence")
tf.flags.DEFINE_string("y_train_filepath", "../data/dataset/sample_seq2seq/train/train.title.txt", "Path to a file containing Y training title")
...
def preprocess():
    ...
    x_train, article_max_len = vocab_utils.transform_text(x_text, word_dict)
    y_train = vocab_utils.transform_text_y_seq2seq(y_text, word_dict, FLAGS.summary_max_len)


    return x_train, y_train, word_dict, reversed_dict, article_max_len, [], []




def train(x_train, y_train, word_dict, reversed_dict, article_max_len, x_valid, y_valid):
...
def main(argv=None):
    ...
    x_train, y_train, word_dict, reversed_dict, article_max_len, x_valid, y_valid = preprocess()
    train(x_train, y_train, word_dict, reversed_dict, article_max_len, x_valid, y_valid)
